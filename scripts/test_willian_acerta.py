#!/usr/bin/env python3
"""Testar ACERTA com login willian.demuner - verificar erro Excel."""
import os, time
...
with sync_playwright() as p:
    ...
    if not info['hasError'] and info['rowCount'] > 0:
        ...
        page.screenshot(path='/tmp/acerta_willian.png', full_page=True)
        print('Screenshot salvo')
    else:
        print(f'Erro na pesquisa: {info["body"]}')

#!/usr/bin/env python3
"""Debug LOGA: verificar valores dos campos após carregar filtro."""
import os, json
...
with sync_playwright() as p:
    ...
    print('LOGA - Valores após carregar filtro:')
    print(json.dumps(valores, indent=2, ensure_ascii=False))
    
    page.screenshot(path='/tmp/loga_filtro_carregado.png', full_page=True)
